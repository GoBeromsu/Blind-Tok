...
async function handleCameraChange() {
  ...
  if (localParticipant.src) {
    ...
    const videoSender = localParticipant.src.getSenders().find(sender => sender.track.kind === "video");
...
async function handleAudioChange() {
  ...
  if (localParticipant.src) {
    ...
    const audioSender = localParticipant.src.getSenders().find(sender => sender.track.kind === "audio");
