...
const ChatList = ({user}) => {
  ...
  const filteredChatRoom = chatList.filter(chat => chat.room_name.toLowerCase().includes(search.toLowerCase()));
  ...
  const filteredFriends = friendList.filter(friend => friend.nickname.toLowerCase().includes(search_f.toLowerCase()));
